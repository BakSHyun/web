...
<style type="text/css">
#layer_container_exps{position:absolute; top:287px; left:50%; z-index:9999999; visibility: visible; overflow:hidden; width:500px; margin-left:-611px} /* 팝업 레이어 스타일 */
			...
			<tr>
				<td valign="bottom">
					<div class="pager_sty_ctr">
						<dl class="rollpop_inner_exps">
							<!-- <dd><a href="https://www.cseye.net/07_counsel/community3.php?group=basic&code=community03&no=84678&bsort=desc&bfsort=ino&abmode=view"><img src="img/popup_200226.jpg" /></a></dd> -->
							<dd><a href="../07_counsel/community3.php?sno=0&group=basic&code=community03&category=&&cate1=&cate2=&cate3=&abmode=view&no=84751&bsort=&bfsort="><img src="img/popup200423.jpg" /></a></dd>
						</dl>
					</div>
				</td>
			</tr>
