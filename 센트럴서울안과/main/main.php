...
<? //include_once "pop161121.php"; ?> <!-- 수능팝업  -->
<? //include_once "popup_161228.php"; ?>
<? include_once "pop180711.php"; ?> <!-- 코로나팝업  -->
<? //include_once "pop200410.php"; ?> <!-- 선거휴진팝업  -->

		<!-- 메인비주얼 시작 -->
		<div class="main_visual" style="width:100%;max-width:1903px;min-width:1200px;overflow:hidden;">
			<div id="mainvi" class="owl-carousel owl-theme">
			  ...
			  <a href="/07_counsel/community3.php?sno=0&group=basic&code=community03&category=&&cate1=&cate2=&cate3=&abmode=view&no=84740&bsort=desc&bfsort=ino"><div class="item" style="background:url(../img/main/mv_200408.jpg) no-repeat center; height: 665px;"> </div></a>
			  <a href="/02_cataract/cataract9.php"><div class="item" style="background:url(../img/main/mv03.jpg) no-repeat center; height: 665px;"> </div></a>
			  ...
			  <div class="item" style="background:url(../img/main/mv05_200410.jpg) no-repeat center; height: 665px;"><a href="../01_intro/intro3.php" style="position: absolute;width: 186px;    height: 30px;left: 50%;margin-left: -600px;bottom: 125px;"></a> </div>
			</div>
			<div id="owlStatus">
      ...
      if(ifr_source.indexOf('?') != -1) $(this).attr('src',ifr_source+'&'+wmode);
		...
		<div class="main_content">
			<div class="main_box">
				...
				<ul class="main_box01">
					<li>
						<a href="../01_intro/intro3.php#section01"><img src="../img/main/li_img01_200413.png" alt="" />
						<h2>EXPERT Doctors</h2>
						<p>국제적 권위를 가진</br>안과전문의 6인 진료</p></a>
					</li>
					<li>
						<a href="../01_intro/intro3.php#section02"><img src="../img/main/li_img02_200413.png" alt="" />
						<h2>EXPERT Patient Care</h2>
						<p>더 나은 진료를 위한</br>고객맞춤형 환자 관리 시스템</p></a>
					</li>
					<li>
						<a href="../01_intro/intro3.php#section03"><img src="../img/main/li_img03_200413.png" alt="" />
						<h2>EXPERT Devices</h2>
						<p>업데이트된 안과 진료 장비로</br>안전한 수술 가능</p></a>
					</li>
					<li>
						<a href="../01_intro/intro3.php#section04"><img src="../img/main/li_img04_200413.png" alt="" />
						<h2>EXPERT Safety</h2>
						<p>고객의 안전 보장을 위한</br>노력은 기본입니다</p></a>
					</li>
					<li class="last">
						<a href="../01_intro/intro3.php#section05"><img src="../img/main/li_img05_200413.png" alt="" />
			...
			<div class="main_box">
				<ul class="main_icon01">
					...
					<li><a href="../02_cataract/cataract2.php"><img src="../img/main/main_icon_01.jpg" alt="백내장" /></a></li>
					<li><a href="../04_glaucoma/glaucoma9.php"><img src="../img/main/main_icon_02.jpg" alt="녹내장" /></a></li>
			...
			<div class="main_box">
				<div id='mb01'>
					<ul class="bxslider01">
					  <!--<li><a href="http://cseye.net/m_old/landing/landing5.html" target="_blank"><img src='../img/main/popup190711.jpg' alt='이벤트'/></a></li>-->
					  <!--<li><a href="https://www.youtube.com/channel/UC2FUiZl5XTXj6eDQRhdJb2w" target="_blank"><img src='../img/main/mb01_9.jpg' alt='녹내장TV'/></a></li>-->
					  <li><a href="#tab02"><img src='../img/main/mb01_6.jpg' alt='안구건조증 검사장비'/></a></li>
					  <li><a href="../01_intro/intro7.php#tab03"><img src='../img/main/mb01_1.png' alt='컴퓨터네비게이션시스템'/></a></li>
					  <li><a href="../01_intro/intro7.php#tab04"><img src='../img/main/mb01_2.png' alt='백내장수술기'/></a></li>
					  <li><a href="../01_intro/intro7.php#tab05"><img src='../img/main/mb01_3.png' alt='망막맥락막혈관검사장비'/></a></li>
					  <li><a href="../02_cataract/cataract9.php"><img src='../img/main/mb01_10.jpg' alt='레이저 백내장 수술기'/></a></li>
					  <!-- <li><a href="../07_counsel/counsel2.php"><img src='../img/main/mb01_4.png' alt='백내장수술 사전예약필수 '/></a></li> -->
					</ul>
				</div>
				<div id='mb02'>
					<ul class="bxslider02">
						<!-- <li><img src='../img/main/popup200115_pc.jpg' alt=''/></li> -->
						<!-- <li><a href="http://cseye.net/m_old/landing/landing5.html" target="_blank"><img src='../img/main/mbh_191219.jpg' alt=''/></a></li> -->
						<li><a href="http://health.chosun.com/site/data/html_dir/2020/02/11/2020021101179.html" target="_blank"><img src='../img/main/mbh_200219.jpg' alt=''/></a></li>
						<li><a href="http://health.chosun.com/site/data/html_dir/2019/09/30/2019093001989.html" target="_blank"><img src='../img/main/mb01_191001.jpg' alt=''/></a></li>
						<li><a href="http://health.chosun.com/site/data/html_dir/2018/11/22/2018112202358.html" target="_blank"><img src='../img/main/mb01_8.jpg' alt=''/></a></li>
						<li><a href="https://www.youtube.com/channel/UC2FUiZl5XTXj6eDQRhdJb2w" target="_blank"><img src="../img/main/mb02_15.jpg" alt=""></a></li>
						<!-- <li><img src="../img/main/popup180529.jpg" alt=""></li> -->
						<!--<li><img src='../img/main/mb02_14.jpg' alt=''/></li>-->
					    <li><a href="http://health.chosun.com/site/data/html_dir/2018/04/17/2018041700933.html" target="_blank"><img src="../img/main/mb02_11.jpg" alt="아시아태평양 지역 최고의 클리닉 어워드 수상"></a></li>
				  	    <!--<li><a href="http://health.chosun.com/site/data/html_dir/2017/02/15/2017021501936.html" target="_blank"><img src='../img/main/mb02_8.jpg' alt='조선일보'/></a></li>-->
					    <!--<li><img src='../img/main/mb02_9.jpg' alt='아쿠아ICL'/></li>-->
				...
				<div id="mb_03">
					<a href="http://pf.kakao.com/_xlmiNM/chat" target="_new"><img src="../img/main/main_kakao.jpg" alt="카카오톡" class="m-b-5" /></a>
					<a href="https://www.youtube.com/channel/UC-lxBJ5w49nJyQZ1XeEpfSA?view_as=subscriber" target="_blank"><img src="../img/main/main_youtube01.jpg" alt="유튜브" class="m-b-5" /></a>
