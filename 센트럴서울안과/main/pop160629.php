...
function closeWin_1() {
    if ( document.notice_form_1.chkbox1.checked ){
...
<!-- popup2 div S ---------------------------------------------------------------------------------------------------------------->
<div id="popup1" style="width:475px;  position:absolute;top: 283px; z-index:99999995; visibility: visible;right:50%; margin-right:-450px;">

	<form name="notice_form_1">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		  <td valign="bottom"><a href="http://cseye.net/m/landing/landing01.php" target="_blank"><img src="img/pop160629.jpg" border="0"  /></a></td>
	  </tr>
	</table>
	<table width="475" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				...
				<td style=" background-color:#000; height:30px; padding-right:8px; text-align:right;"><a href="javascript:closeWin_1();"><span style="font-weight:bold;font-size:12px;"><font color="#FFFFFF">[닫기]</font></span></a></td>
			</tr>
	</table>
  </form>
</div>
