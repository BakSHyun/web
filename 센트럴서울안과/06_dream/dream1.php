	...
	<div class="sub_cnt">
		...
		<div class="sub_imgtit">
			<div class="ltxt" style="height:350px;padding-top:70px">
				<h2>자는 동안 편안한 시력교정</h2>
				<h1 style="font-size:60px;margin-top:13px">드림렌즈</h1>
				<p style="color:#fff;font-size:20px;margin-top:30px">잠을 자는 동안 특수렌즈를 통하여 각막을<br>
일시적으로 눌러주어  낮 동안 좋은 시력을<br>
유지할 수 있는 시력교정 방법입니다. </p>
			</div>
			<div class="rimg">
				<img src="../img/sub/dream1_1_new.jpg" alt="드림렌즈" />
			</div>
		</div>
		
		<style>
		.section_cen{text-align:center}
		.section_cen > h3{font-size:33px;margin-bottom:25px;color:#000}
		.section_cen > h3 > span{display:inline-block;margin-top:10px;font-size:18px;color:#5c5c5c;}
		.section_cen > .tit_wrap h2{font-size:45px;font-weight:bold;color:#000}
		.section_cen > .tit_wrap p{font-size:24px;margin-top:18px}
		.section_cen > .tit_wrap:after{content:'';display:block;width:62px;height:1px;background:#1f1f1f;margin:22px auto}
		</style>

		<div class="box_section">			
			<div class="section section_cen">	
				<div class="tit_wrap">
					<h2><strong style="color:#355599">CS드림렌즈</strong> 클리닉</h2>
					<p>정밀한 검사부터 피팅, 사후관리까지 확실하게!</p>
				</div>
				<p class="desc">드림렌즈도 시력교정 수술과 마찬가지로 각막의 모양을 고려한 교정량이 정확해야 합니다.<br>
센트럴 서울안과 드림렌즈 클리닉은 전담검안사를 운영하고 있으며 <br>
정밀검사부터 피팅 및 사후관리까지 맞춤 관리를 시행합니다. </p>
			</div>
			<div class="section section_cen">	
				<h3><strong>CS드림렌즈</strong>는 이렇게 다릅니다.</h3>
				<img src="../img/sub/dream1_2_new.png" alt="" />
			</div>
			<div class="section section_cen">	
				<h3><strong>CS드림렌즈</strong> 인증내역</h3>
				<img src="../img/sub/dream1_3_new.png" alt="" />
			</div>
			<div class="section section_cen">	
				<h3><strong>CS드림렌즈</strong> 렌즈 선택 가이드<br><span>(다양한 피팅 렌즈 보유)</span></h3>
				<img src="../img/sub/dream1_4_new.png" alt="" />
			</div>
...
AC_FL_RunContent( 'type','application/x-shockwave-flash','data','../flash/sub_vod3.swf','width','550','height','406','style','margin:0 auto;','movie','../flash/sub_vod3','wmode','transparent','allowscriptaccess','always' ); //end AC code
</script><noscript><object type="application/x-shockwave-flash" data="../flash/sub_vod3.swf" width="550" height="406" style="margin:0 auto;">
