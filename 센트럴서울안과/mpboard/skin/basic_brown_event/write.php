<?
include $_SERVER["DOCUMENT_ROOT"] ."/".$INDIR."/amlibrary/ajax/ajax.php";  //ajax 라이브러리를 추가 한후 include  (게시판 필터를 위해서 ) 08 .12. 02
...
if($EDITMODE == "webedit") {
	...
	$edit_dir = "/".$INDIR."/webedit/";						// 에디터 경로
	$textarea_obj = "document.wform.contents";		// 폼 내부의 Textarea 객체
	$editobj_name = "eobj";									// 에디터 객체 이름
	...
	?>
	<script>
		document.wform.html.checked=true;	// 에디터 사용시 html 사용을 강제로 체크한다.
	</script>
	<?
}
?>
