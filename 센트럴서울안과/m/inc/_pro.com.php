<style type="text/css">
#program_container_wrap{margin-top:50px ;}
.pro-wp{position:relative; width:600px; height:560px; background-color:#f2f2f2; margin:0 auto;}
.logo-ps{position:absolute; top:65px; left:125px;}
.pro-ps{position:absolute; top:50px; left:50%;margin-left: -222px;}
.pro-ps label{width:70px; font-size:18px; color:#252528; cursor:pointer; float:left; margin-right:25px;}
.pro-ps input{height:40px; border:1px solid #cfcfcf; box-sizing:border-box; float:left; font-size:20px; text-align:center;}
...
#in-name{width:368px !important;}
.in-hphone{width:120px !important; margin-right:4px}
#in-email{width:368px !important;}
.privacy{width:368px; height:75px; background-color:#fff; border:1px solid #cfcfcf; box-sizing:border-box; overflow-y:scroll;margin-left: 95px;}
		...
		<div class="pro-ps">
			<form action="../inc/inc_proc_db.php" enctype="multipart/form2-data" name="procomm" method="post" onsubmit="return prochk()">
				...
				<div class="wp-email">
					...
					<textarea name="contents" id="" style="width:368px; height:100px;border: 1px solid #cfcfcf;font-size:20px;"></textarea>
					<!-- <input type="text" name="email" id="in-email"  placeholder="ex)your@email.com" maxlength="40"> -->
				</div>
				...
				<div class="wp-chkbox">
					<input type="checkbox" name="agree" id="in-chkbox"><label for="in-chkbox" style="font-size:13px; color:#252528; letter-spacing:-0.5px; width:325px;">동의합니다.(고객님은 동의를 거부할 수 있습니다. 거부시에는 해당 서비스 이용이 제한됩니다.)</label>
				</div>
				<div class="wp-btn">
