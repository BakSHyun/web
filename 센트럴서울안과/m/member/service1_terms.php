...
② 환자는 국적, 성별, 연령, 종교, 경제·사회적 지위, 질병의 종류 등 어떤 이유로도 차별 받지 않으며,
평등한 의료 서비스를 받을 권리가 있다.
③ 환자는 최선의 진료를 위하여 지정의 및 의료기관을 선택할 권리가 있다.
④ 환자는 적법한 자격을 갖춘 의료인으로부터 의료행위를 제공받을 권리가 있다.
⑤ 환자 및 보호자는 환자의 진료기록에 관한 정보 및 기록을 요구할 권리가 있다.
⑥ 환자 및 보호자는 환자의 질병상태 및 치료 행위의 목적, 방법, 내용과 그 결과에 대해 설명을 듣고,
치료 방법 또는 치료 거부에 대해 선택할 권리가 있다.
...
⑩ 환자 및 보호자는 병원 내 의료서비스를 포함한 기타 사항에 대해 불만이 있을 경우, 의견을
 표현하고 그에 대하여 답변을 들을 권리가 있다.


환자의 책임
① 환자는 현재 증상, 과거 병력, 약물 치료 및 기타 기록 등 진료에 관련된 사안을 직접 또는 법적 대리인
 을 통해 의료진에게 제공할 책임이 있다.
