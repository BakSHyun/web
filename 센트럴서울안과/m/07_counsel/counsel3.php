...
<style type="text/css">
input[type=checkbox].s_checkbox {position:relative;top:-1px;margin-right:5px;width:15px;height:15px;border:0;border-radius:0;background:url('http://cseye.net/mpboard/skin/txt_res_counsel_type1/skin_images/chk_img.gif') no-repeat 0 0;appearance:none;-webkit-appearance:none;-moz-appearance:none;background-size:15px 30px;}
...
<div class='sub_content'>
	<img src="../img/board/board_img03.jpg" alt="">
	...
	<div class="sub_cnt">
		<div class="board_wrap">
			...
			<!--<p style="font-size:13px;">
				※ 성함과 연락처를 남겨주시면, 센트럴서울안과에서 병원 업무시간 중 카카오톡으로 인사드립니다.<br/>
				※ 직접 상담 문의 원하시는 분은 <strong style="color:#F17C03">카카오톡 아이디 검색</strong>에서 <strong style="color:#F17C03">'cseye365'</strong>를 검색하세요.
			</p>-->
