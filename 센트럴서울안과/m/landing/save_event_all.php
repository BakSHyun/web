...
title = '".$name." 님의 이벤트신청입니다. 연락처 : ".$hphone1."-".$hphone2."-".$hphone3."',
cate1 = '".$cate1_input."',
cate2 = '".$cate2_input."',
hphone1 = '".$hphone1."',
hphone2 = '".$hphone2."',
...
mysql_query($SQL1);
	...
	$msg = $msg . " 이벤트 신청하기가  등록되었습니다.";//.$SITE_INFO[url];

	$to_hphone = $hphone1.$hphone2.$hphone3;
	$snd_number =$adm_sql[adm_phone];  //보내는 사람 번호를 받음
	$rcv_number="01089407212";    //받는 사람 번호를 받음
	//$rcv_number="01043110919";    //받는 사람 번호를 받음
	//$rcv_number2="01033895890";    //받는 사람 번호를 받음
	//$rcv_number3="01031562078";    //받는 사람 번호를 받음
