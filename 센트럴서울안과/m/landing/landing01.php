...
<div class="wrapper">
	<div class="cnt">
		<img src="img/landing01_1.jpg" alt="">
	</div>
	<div class="councel">
	<form name="form" method="post" action="/inc/proc3_db.php" onSubmit="return check_mini(this);">
		...
		<div class="councel_cnt">
			...
			<p class="c_telarea">
				<input type="tel" class="c_phone1" name="hphone1" />
				<input type="tel" class="c_phone2" name="hphone2" />
				<input type="tel" class="c_phone3" name="hphone3" />
			</p>
