...
//exit;
	...
	$mms_title = $_POST["mms_title"];					//MMS 메세지 제목
	...
	$mms_content = "서울특별시 용산구 이촌로 224 \n 한강쇼핑센터 2층\n 센트럴서울안과\n\n 이촌역 4번출구 \n \n 문의) 02-792-2226";		//전송 내용을 받음


	$path = "./images/mms/";											 // 서버상의 MMS 발송 이미지 저장 절대경로
	$filename1 = "map.jpg";									// MMS 발송할 첫번째 파일이름
