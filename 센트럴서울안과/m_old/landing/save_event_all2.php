...
name = '".$name."',
contents = '".$name." 님의 YOLO 이벤트신청입니다.<br/>요청페이지 : ".$gourl." <br/> 연락처 : ".$hphone1."-".$hphone2."-".$hphone3." <br/>".$contents."',
title = '".$name." 님의 ".$etc1." ".$etc2."YOLO 이벤트신청입니다. 연락처 : ".$hphone1."-".$hphone2."-".$hphone3."',
cate1 = '".$cate1_input."',
cate2 = '".$cate2_input."',
hphone1 = '".$hphone1."',
hphone2 = '".$hphone2."',
...
//exit;
	...
	$msg = $msg . " YOLO 이벤트신청하기가  등록되었습니다.";//.$SITE_INFO[url];
	...
	*/
	$rcv_number="01033895890";    //받는 사람 번호를 받음
	$rcv_number2="01043110919";    //받는 사람 번호를 받음
	$rcv_number3="01088058515";    //받는 사람 번호를 받음
	$rcv_number4="01050992184";    //받는 사람 번호를 받음
	$rcv_number5="01093368630";    //받는 사람 번호를 받음
	$rcv_number6="01025797259";    //받는 사람 번호를 받음
	//$rcv_number7="01043110919";    //받는 사람 번호를 받음
	...
	*/
	...
	$result5=$sms->SendSMS($sms_id,$sms_pwd,$snd_number,$rcv_number5,$sms_content);// 5개의 인자로 함수를 호출합니다.
	$result6=$sms->SendSMS($sms_id,$sms_pwd,$snd_number,$rcv_number6,$sms_content);// 5개의 인자로 함수를 호출합니다.
	$result7=$sms->SendSMS($sms_id,$sms_pwd,$snd_number,$rcv_number7,$sms_content);// 5개의 인자로 함수를 호출합니다.
