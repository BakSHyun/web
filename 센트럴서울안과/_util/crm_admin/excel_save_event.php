...
<table border="1" style="font-size:9pt">
	<tr bgcolor="d1d1d1">
		...
		<?}?>
		<td align="center"><strong>항목1</strong></td>
		<td align="center"><strong>항목2</strong></td>
		<td align="center"><strong>항목3</strong></td>
		<td align="center"><strong>항목4</strong></td>
		<td align="center"><strong>항목5</strong></td>
		<td align="center"><strong>항목6</strong></td>
		<td align="center"><strong>항목7</strong></td>
		<td align="center"><strong>항목8</strong></td>
		<td align="center"><strong>항목9</strong></td>
		<td align="center"><strong>항목10</strong></td>
		<td align="center"><strong>상담가능날짜</strong></td>
		<td align="center"><strong>접속주소</strong></td>
		<td align="center"><strong>작성위치</strong></td>
...
?>
	<tr>
		...
		<?}?>
		<td align="center"><?=$row[etc1]?></td>
		<td align="center"><?=$row[etc2]?></td>
		<td align="center"><?=$row[etc3]?></td>
		<td align="center"><?=$row[etc4]?></td>
		<td align="center"><?=$row[etc5]?></td>
		<td align="center"><?=$row[etc6]?></td>
		<td align="center"><?=$row[etc7]?></td>
		<td align="center"><?=$row[etc8]?></td>
		<td align="center"><?=$row[etc9]?></td>
		<td align="center"><?=$row[etc10]?></td>
		<td align="center"><? if($row[wyear]){?><?=$row[wyear]?>년 <?=$row[wmonth]?>월 <?=$row[wday]?>일 <?=$row[whour]?><?}?></td>
		<td align="center"><?=$row[referer_page]?></td>
